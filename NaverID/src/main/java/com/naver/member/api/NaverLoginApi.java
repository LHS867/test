...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "cJ90bz0JzzYyC3dJfSrP";
	private final static String CLIENT_SECRET = "wgbs5lzbZy";
	
	// Callback URL
	private final static String REDIRECT_URI = "http://localhost:9091/member/naverloginok";
	...
	// 네이버 아이디로 Callback 처리 밈ㅊ AccessToken 획득 메소드
